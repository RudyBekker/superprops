...
import FeatureIcon9 from '../../assets/image/JustHostMain/secure.png';
...
export const PROCESS_ITEMS = [
  ...
  {
    image: Process2,
    title: 'Get Your Free 10GB Storage',
    description:
      'Instantly Get 10GB For Life For FREE',
  },
  {
    image: Process3,
    title: 'Share With Your Friends',
    description:
      'Get 10GB Extra on Every Referral',
  },
];
...
export const FEATURES = [
  {
    ...
    title: 'Privacy',
    description:
      'By properly applying end-to-end encryption, JustHost achieves actual privacy by design.',
  },
  {
    icon: FeatureIcon5,
    title: 'Secure',
    description:
      'JustHost is carefully engineered to achieve the highest level of security for its users.',
  },
  {
    icon: FeatureIcon5,
    title: 'Cloud Storage',
    description:
      'All Your Documents, Movies, Videos, Pictures & Files',
  },
  {
    icon: FeatureIcon5,
    title: 'Collaboration',
