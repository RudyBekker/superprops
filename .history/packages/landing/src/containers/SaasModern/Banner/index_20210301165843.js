...
import BannerImage from 'common/assets/image/JustHostMain/google2.png';
      ...
      <Container>
        <Box {...row}>
          <Box {...contentWrapper}>
            <DiscountWrapper>
              <DiscountLabel>
                <Text {...discountAmount} content="Save 75%" />
                <Text
                  {...discountText}
                  content="On All Lifetime Deals"
                />
              </DiscountLabel>
            </DiscountWrapper>
            <Heading
              {...title}
              content="Secure Cloud Storage"
            />
            <Text
              {...description}
            ...
            />
            <Box {...buttonWrapper}>
              <Link href="https://consultoconseil.typeform.com/to/lt2o51dY">
                <a>
