...
import ImageOne from 'common/assets/image/JustHostMain/google2.png';
//import ImageOne from 'common/assets/image/saasModern/dash-1.png';
import ImageTwo from 'common/assets/image/JustHostMain/google2.png';
      ...
      <Container>
        <Box {...row} {...textAreaRow}>
          <Box {...col} {...textArea}>
            <Heading
              {...title}
              content="Easy and secure access to all of your content"
            />
            <Text
              {...description}
              content="Store, share, and collaborate on files and folders from any mobile device, tablet, or computer"
            />
            <Box>
              <Link href="#">
                <a>
                  <Button {...button} title="START FREE TRIAL" />
                </a>
              </Link>
            </Box>
          </Box>
